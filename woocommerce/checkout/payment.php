...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<h3 id="order_review_heading"><?php _e( 'Payment Alternatives', 'orcp' ); ?></h3>
	...
	<div class="form-row place-order">
		...
		<?php if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) : ?>
			<p class="form-row terms">
				<label for="terms" class="checkbox"><input type="checkbox" class="input-checkbox" name="terms" <?php checked( apply_filters( 'woocommerce_terms_is_checked_default', isset( $_POST['terms'] ) ), true ); ?> id="terms" /> <?php printf( __( 'I agree to the <a href="%s" target="_blank">terms &amp; conditions</a>', 'woocommerce' ), esc_url( wc_get_page_permalink( 'terms' ) ) ); ?></label>
			</p>
		<?php endif; ?>
