...
if ( ! function_exists( 'orcp_clean_post_transients' ) ) :
	 ...
	 */
	function orcp_clean_post_transients( $post_id ) {
	...
	// add_action( 'publish_post', 'orcp_clean_post_transients' );

endif;

if ( ! function_exists( 'orcp_get_transient_query' ) ) :
	 ...
	 */
	function orcp_get_transient_query( $transient_name, $query_args, $transient_time = HOUR_IN_SECONDS ) {
...
if ( ! function_exists( 'orcp_get_transient_posts' ) ) :
	 ...
	 * @param  int 	$transient_time A time for how long the data should be cached.
	 */
	function orcp_get_transient_posts( $transient_name, $query_args, $transient_time = HOUR_IN_SECONDS ) {
...
if ( ! function_exists( 'orcp_get_transient_terms' ) ) :

	function orcp_get_transient_terms( $transient_name, $taxonomy_name, $taxonomy_args = '', $transient_time = HOUR_IN_SECONDS ) {
